							...
							<tbody id="form-actions">
								...
								<tr>						
									...
									<td class="col-lg-4">
										...
										<input type="submit" id="add-category" class="btn btn-info btn-large" tabindex="5" name="add-category" value="Save Changes" />
			           					<a href="<?php echo base_url();?>admin/main_category" class="btn btn-danger btn-large">Cancel</a>
			        				</td>						
									<td class="col-lg-4"></td>
								</tr>
							</tbody>

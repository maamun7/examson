						...
						<table class="table table-condensed table-striped">
							...
							<tbody id="form-actions">
								<tr>						
									...
									<td class="col-lg-4">
                                        <select tabindex="1" name="category_id" class="form-control">
								...
								<tr>						
									...
									<td class="col-lg-4">
										<input type="text" tabindex="2" class="form-control" name="sub_cat_name" value="<?php if (isset($sub_cat_name_value)) { echo $sub_cat_name_value; } ?>" placeholder="Enter Sub Category Name" />
									</td>

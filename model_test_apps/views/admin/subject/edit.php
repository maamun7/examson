						...
						<table class="table table-condensed table-striped">
							...
							<tbody id="form-actions">
								...
								<tr>						
									...
									<td class="col-lg-4">
										<input type="hidden" name="subject_id" value="<?php if (isset($subject_id)) { echo $subject_id; } ?>" />
										<input type="submit" id="add-subject" class="btn btn-info btn-large" tabindex="5" name="add-subject" value="Save Changes" />
			           					<a href="<?php echo base_url();?>admin/subject" class="btn btn-danger btn-large">Cancel</a>
			        				</td>					
									<td class="col-lg-4"></td>
								</tr>
							</tbody>
